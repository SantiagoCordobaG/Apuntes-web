...
const generarEtiquetas = () => {
  ...
  // Agregar etiquetas generadas al formulario (sin duplicados)
...
// Watch para regenerar etiquetas cuando cambian título o descripción
let timeoutId = null;
watch([() => form.title, () => form.description], () => {
  if (form.autoTagging && form.file) {
    // Debounce: esperar 500ms antes de regenerar
